...
## What this repo is
Meta-tooling for a solo agentic engineering workflow: shared agents, skills,
...
- 11 sub-agents (.claude/agents/): coordinator, spec-writer, implementation-engineer,
  code-review, security-audit, i18n-auditor, brand-guardian, performance-auditor,
  qa-testing, git-operator, researcher
