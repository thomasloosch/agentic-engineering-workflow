...
**Current corpus (updated 2026-08-18, after #26 slices 0-3).** 14 individually
visible rows (agent-self: 7, human: 4, automatic-gate: 3) **plus** three collapsed
promotion lines (`artifact-vs-effect` 2h+1a, `wrong-invocation-path` 2h+1a,
`fail-open-guard` 0h+3a) = **agent-self: 12, human: 8, automatic-gate: 3** across
23 catches.
...
*Archive: none yet — 14 individual rows + 3 collapsed promotion lines = 23 catches
